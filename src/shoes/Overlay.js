...
export function Overlay() {
  ...
  return (
    <>
      <div style={{ position: 'absolute', top: 0, left: 0, width: '90%', height: '100%' }}>
        <a href="https://pmnd.rs/" style={{ position: 'absolute', bottom: 40, left: 40, fontSize: '13px' }}>
          PMND.RS
          <br />
          DEV COLLECTIVE
        </a>
        <div style={{ position: 'absolute', bottom: 40, right: 140, fontSize: '13px' }}>02/02/2023</div>
      </div>
      ...
      <div className="info">
        ...
        <List open={state.open}>
          ...
          <h3>“ZOOM”</h3>
          <h3>
            <span className="accent">KRISHNA</span>
          </h3>
          <h4>Running Shoes</h4>
